...
const ScenarioComp = ({ formik, data }) => {
  ...
  return (
    <>
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            <Stack sx={{ marginLeft: "50px", marginTop: "20px", width: '50%' }}>
              ...
              <input
                placeholder="Enter Minimum Transaction Value"
                style={{
                  fontSize: "12px",
                  color: "#0B7974",
                  width: "100%",
                ...
                onChange={(e) =>
                  formik.setFieldValue("minTransactionValue", e.target.value)
                }
                defaultValue={data?.eventId ? data?.minTransactionValue : ""}
              />
              {formik?.errors?.minTransactionValue ? (
                <FormHelperText style={{}} error>
                  {formik?.errors?.minTransactionValue}
                </FormHelperText>
              ) : null}
          ...
          <div style={{ display: "flex" }}>
            ...
            <Stack sx={{
              marginLeft: "50px", marginTop: "30px", width: '33.3%', '@media (max-width: 827px)': {
                marginLeft: "30px",
              },
            }}>
              <TextFieldComp
      ...
      {formik?.errors?.storeId ? (
        <FormHelperText
          style={{ paddingLeft: "40px", paddingTop: "2px" }}
          error
        >
          {formik?.errors?.storeId}
        </FormHelperText>
