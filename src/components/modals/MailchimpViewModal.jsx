        ...
        <AdditionalNotesBody>
          ...
          >
            ...
            >
              <div>
                <p>
                  To enable the webhooks to get updated record of mailchimp campaigns with platform
                </p>

                <p>1- Go to audiences </p>
                <p>2- Click on manage audience </p>
                <p>3- Select settings, In setting select Webhook</p>
                <p>4- Create webhook </p>

                <p style={{ marginTop: "30px", fontWeight: "600" }}>
                  Enter the url as API endpoint as setting, with the email
                  address registered with platform at end of the endpoint:
                  <div style={{ marginTop: "20px", fontWeight: "normal" }}>
                    https://api.loyallocker.com/api/v2/merchant/webhook/campaign-updates/:email
                  </div>
                </p>
              </div>
              <ShopifyModalTextContainer>
            ...
            ></div>
              ...
              <div
                style={{ height: "1px", width: "auto", background: "grey" }}
              ></div>
            </div>
          </div>
        </AdditionalNotesBody>
...
export default MailchimpViewModal;
