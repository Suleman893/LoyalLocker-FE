...
`;
export const ShopifyModalTextContainer = styled.div`
      /* margin-top: 15px;
      margin-bottom: 20px;
      padding:1px; */
`;
...
`;
export const AdminAllCompanyModalContainer = styled.div`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
...
`;
export const AdditionalNotesContainer2 = styled.div`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
